...
export default function Setting() {
  ...
  return (
    <>
        <div className={` ${isVisible ? "" : "hidden lg:block" } h-[90dvh] w-full lg:w-[30dvw] fixed bg-white border-black lg:border-x-2 lg:static bottom-0 flex flex-col font-semibold`}>
